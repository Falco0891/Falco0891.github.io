...
<head>
  ...
  <title>Werknemerloket.nl | Dashboard</title>
  <meta charset="utf-8">
</head>
  ...
  <div class="d-flex" id="wrapper">
    <div id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        <a href="index.php" class="list-group-item list-group-item-active list-group-item-action">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-header">
            ...
            <span class="card-title-description">title description</span>
          </div>
